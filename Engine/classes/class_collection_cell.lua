...
local CC = class.Collection_Cell(Collection)
...
CC.add = function(self,object,id)
    ...
    if pcall( function() return object.is_a(self,Cell) end ) then
        new_agent = object
    else
...
CC.create_n = function(self,num, funct)
    for i=1,num do
        self:add( Cell( funct() ) )
    end
end
