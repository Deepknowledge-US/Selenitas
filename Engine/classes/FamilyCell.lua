...
-- When a new Cell Family is created, its father's init function is called. This allows the new Collection_Patches to use all the methods of the Collection class.
FC._init = function(self,c)
    self:super(c)
    return self
end

-- This function overwrites the add method of the Family class
...
-- This function overwrites the create_n method of the Family class
